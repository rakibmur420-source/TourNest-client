...
export default function CTA() {
  return (
    <section className="mx-auto max-w-7xl px-5 pb-20 lg:px-8">
      ...
      <div className="flex flex-col items-center justify-between gap-6 rounded-3xl border border-amber/30 bg-white px-6 py-10 text-center sm:flex-row sm:text-left sm:px-12">
        <div>
